...
const Signup = ({ darkMode }) => {
  ...
  function onSubmit(e) {
    e.preventDefault();
    const url = "https://eventmanagement-b7vf.onrender.com/api/auth/register";
  ...
  return (
    <div
      className={`flex justify-center items-center min-h-screen ${
        darkMode ? "bg-dark-bg" : "bg-gray-100"
      }`}
    >
      <div
        className={`p-8 rounded-lg shadow-lg w-full max-w-md sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl ${
          darkMode ? "bg-dark-card" : "bg-white"
        }`}
      >
        <h2
          className={`text-2xl font-bold mb-6 text-center ${
            darkMode ? "text-dark-text" : "text-black"
          }`}
        >
          Sign Up
        </h2>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                darkMode
                  ? "border-dark-border text-dark-input"
